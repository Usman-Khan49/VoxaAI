...
// Sample history data
const historyData = [
  { id: '1', title: 'Voice 01', date: '08/11/2025 - 11:06 AM', duration: '0:05' },
  { id: '2', title: 'Voice 02', date: '08/11/2025 - 11:06 AM', duration: '0:12' },
  { id: '3', title: 'Voice 03', date: '08/11/2025 - 11:06 AM', duration: '0:08' },
];
        ...
        >
          ...
          <View style={styles.featureCardsContainer}>
            ...
            <TouchableOpacity style={styles.featureCard} activeOpacity={0.8}>
              ...
              <Text style={styles.featureDescription}>Record and enhance your voice in real-time</Text>
              <TouchableOpacity 
            ...
            <TouchableOpacity style={styles.featureCard} activeOpacity={0.8}>
              ...
              <Text style={styles.featureDescription}>Upload audio to fix accent and grammar</Text>
              <TouchableOpacity 
                style={styles.featureButton}
